...
export const ModeToggle = ({ mode, setMode, listening, setListening, transcript }: ModeToggleProps) => {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-slate-400">Переключайтесь голосом или кликом в любой момент</div>
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          {mode === 'voice' ? (
            ...
            >
              ...
              <span className="text-sm font-medium">{listening ? 'Слушаю...' : 'Сказать «Неврон»'}</span>
            </motion.button>
          ) : (
            <motion.div
              key="manual-btn"
