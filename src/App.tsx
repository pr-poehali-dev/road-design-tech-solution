    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/kpferm" element={
            <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Загрузка...</div>}>
              <KpFerm />
            </Suspense>
          } />
          <Route path="/kpshefran" element={
            <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Загрузка...</div>}>
              <KpShefran />
            </Suspense>
          } />
          ...
          <Route path="/sochi" element={
            <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Загрузка...</div>}>
              <KpSochi />
            </Suspense>
          } />
          <Route path="/dksochi" element={
            <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Загрузка...</div>}>
              <DkSochi />
            </Suspense>
          } />
          ...
          <Route path="/abipkyzbas" element={
            <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Загрузка...</div>}>
              <Abipkyzbas />
            </Suspense>
          } />
          <Route path="/CSTKkyz" element={
            <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Загрузка...</div>}>
              <CSTKkyz />
            </Suspense>
          } />
