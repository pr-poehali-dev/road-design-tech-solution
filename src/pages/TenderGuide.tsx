...
const testQuestions = [
  ...
  {
    question: 'Что входит в формулу «красной линии» цены?',
    options: [
      'Только стоимость КП',
      'КП + Доп. расходы на тендер + Комиссия',
      'Только комиссия партнёра',
      'Средняя рыночная цена'
    ],
    correctAnswer: 1,
    explanation: 'Красная линия = КП + Дополнительные расходы на тендер + Комиссия партнёра.'
  },
  {
    question: 'Что такое COP-досье?',
    options: [
      'Бухгалтерский документ',
      'Документ с контактами ЛПР и договорённостями',
      'Юридическая экспертиза',
      'Финансовый отчёт'
    ],
    correctAnswer: 1,
    explanation: 'COP-досье содержит контакты ЛПР, договорённости и согласованное КП для тендерного отдела.'
  },
  {
    question: 'Кто отвечает за выход на ЛПР?',
    options: [
      'Тендерный отдел',
      'Партнёр',
      'Юридический отдел',
    ...
    correctAnswer: 1,
    explanation: 'Правило 2: выход на ЛПР — зона ответственности партнёра в рамках COP.'
  },
  {
    question: 'Что делает тендерный отдел при неполном COP-досье?',
    options: [
      'Дорабатывает сам',
      'Отказывает в подаче',
      'Подаёт заявку без доработки',
      'Обращается к руководству'
    ],
    correctAnswer: 1,
    explanation: 'При неполном COP-досье тендерный отдел отказывает в подаче до доработки партнёром.'
  },
  {
    question: 'Зачем нужна видеозапись процесса на площадке?',
    options: [
      'Для рекламы',
      'Для обучения новых сотрудников',
      'Для полного контроля и разбора результатов',
      'По требованию закона'
    ],
    correctAnswer: 2,
    explanation: 'Видеозапись всего процесса нужна для контроля, прозрачности и разбора результатов.'
  },
  {
    question: 'Что такое Фаза 1 COP?',
    options: [
      'Подача документов',
    ...
    correctAnswer: 1,
    explanation: 'Фаза 1 COP — разведка: мониторинг планов закупок и выход на ЛПР.'
  },
  {
    question: 'Когда партнёр должен выйти на заказчика?',
    options: [
      'После публикации тендера',
      'До объявления тендера',
      'Во время аукциона',
      'После победы'
    ],
    correctAnswer: 1,
    explanation: 'Правило 2: выход на ЛПР до объявления тендера для согласования ТЗ и критериев.'
  },
  {
    question: 'Что лучше — работа в убыток или проигрыш тендера?',
    options: [
      'Работа в убыток',
      'Проигрыш тендера',
      'Оба варианта плохие',
    ...
    correctAnswer: 1,
    explanation: 'Правило 3: проигрыш лучше, чем работа себе в убыток. Сохраняем маржу.'
  },
  {
    question: 'Что проверяет тендерный отдел на этапе стратегической проверки?',
    options: [
      'Финансовую отчётность',
      'Соответствие документов договорённостям в COP',
      'Репутацию конкурентов',
      'Юридическую чистоту'
    ],
    correctAnswer: 1,
    explanation: 'Стратегическая проверка: сверка документов тендера с договорённостями из COP-досье.'
  },
  {
    question: 'Что включает Фаза 2 COP?',
    options: [
      'Подача документов',
      'Экспертная сессия и формирование КП',
      'Мониторинг конкурентов',
      'Юридическая проверка'
    ],
    correctAnswer: 1,
    explanation: 'Фаза 2 COP: встреча-интервью, согласование ТЗ, подготовка и согласование КП.'
  },
  {
    question: 'Почему нельзя регистрироваться на площадках от личного имени?',
    options: [
      'Это незаконно',
      'Нет единой юридической защиты и репутации',
      'Площадки не разрешают',
      'Дорого'
    ],
    correctAnswer: 1,
    explanation: 'Правило 1: личные регистрации = нет единой юридической защиты и централизованного управления рисками.'
  },
  {
    question: 'Что делать, если критерии в тендере изменились?',
    options: [
      'Сразу отказаться',
      'Выяснить причины через партнёра или пересчитать риски',
      'Подавать без изменений',
      'Жаловаться в ФАС'
    ],
    correctAnswer: 1,
    explanation: 'При изменении критериев: выясняем причины через партнёра или пересчитываем риски.'
  },
  {
    question: 'Кто принимает решение о снижении цены ниже красной линии?',
    options: [
      'Партнёр',
      'Тендерный отдел',
      'Только руководство с санкции',
      'Клиент'
    ],
    correctAnswer: 2,
    explanation: 'Снижение цены ниже минимума возможно только с санкции руководства, тендерный отдел отказывает.'
  },
  {
    question: 'Что такое ПГЗ?',
    options: [
      'Программа государственных закупок',
      'План-график закупок',
      'Положение о госзаказе',
      'Портал государственных закупок'
    ],
    correctAnswer: 1,
    explanation: 'ПГЗ — план-график закупок по 44-ФЗ, публикуется на год вперёд для планирования.'
  },
  {
    question: 'Что включает Фаза 3 COP?',
    options: [
      'Аукцион',
      'Оформление допуска и передача досье тендерному отделу',
      'Подписание договора',
      'Мониторинг конкурентов'
    ],
    correctAnswer: 1,
    explanation: 'Фаза 3 COP: заполнение COP-досье, передача тендерному отделу, решение о допуске к подаче.'
  }
];
