...
const STAGES = [
  { n: 1, title: "Социально-экономическая характеристика района", sum: 33_500 },
  { n: 2, title: "Сбор данных о существующем транспорте", sum: 46_100 },
  { n: 3, title: "Натурное транспортное обследование", sum: 75_400 },
  { n: 4, title: "Прогноз интенсивности на 20 лет (2028, 2046)", sum: 79_700 },
  { n: 5, title: "Расчёт по узлам и сечениям (6 точек)", sum: 75_400 },
  { n: 6, title: "Определение категории дороги", sum: 33_500 },
  { n: 7, title: "Расчёт экономической эффективности", sum: 41_900 },
