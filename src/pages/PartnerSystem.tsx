...
const PartnerSystem = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-hidden">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <button
              ...
              className={`text-xs md:text-sm transition ${
                activeTab === 'main' ? 'text-cyan-400' : 'text-slate-300 hover:text-cyan-400'
              }`}
            >
              Экосистема
            </button>
            <button
              ...
              className={`text-xs md:text-sm transition ${
                activeTab === 'simulator' ? 'text-cyan-400' : 'text-slate-300 hover:text-cyan-400'
              }`}
            >
              Симулятор
            </button>
            <button
              ...
              className={`text-xs md:text-sm transition ${
                activeTab === 'knowledge' ? 'text-cyan-400' : 'text-slate-300 hover:text-cyan-400'
              }`}
            >
              База знаний
            </button>
      ...
      <div className="pt-20 pb-16">
        ...
        {activeTab === 'simulator' && (
          <div className="container mx-auto px-4 md:px-6">
            <SimulatorSection calculatorData={calculatorData} setCalculatorData={setCalculatorData} calculateIncome={calculateIncome} />
          </div>
        )}
      ...
      {/* Old Hero Section - moved to knowledge base */}
      <section className="hidden relative min-h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-0">
        {/* Animated Background */}
        <div
...
const SimulatorSection = ({ calculatorData, setCalculatorData, calculateIncome }: any) => {
  return (
...
// Компонент базы знаний (старый контент)
