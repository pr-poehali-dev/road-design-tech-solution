...
const STAGES = [
  ...
  },
  {
    ...
    text: "Денис, ты и Евгений. Платформа для проектирования. Это не просто бизнес — это первый шаг к полному доминированию над строительной отраслью на трёх планетах. Четвёртая планета пока не знает, что ей не повезло.",
          ...
          <div className="space-y-4">
            ...
            <div className="border rounded-xl p-5 text-left space-y-3" style={{ borderColor: current.accent + "55", backgroundColor: current.accent + "11" }}>
              ...
              <p className="text-gray-100 text-sm leading-relaxed">
                Женя, ты реально крутой инженер и человек. Без тебя вся наша инженерная часть была бы просто красивыми словами. Ты тот, кто превращает идеи в реальные расчёты — а это, как сказал бы Рик, «буквально единственное, что имеет значение во вселенной».
              </p>
              <p className="text-gray-100 text-sm leading-relaxed">
                Пусть в этом году клиенты сами знают что хотят, смета сходится с первого раза, а все согласования проходят за один звонок. Это невозможно? Ну и что — ты же инженер.
              </p>
              <p className="font-bold text-sm" style={{ color: current.accent }}>
                С днём рождения! 🛸 Держи курс на миллиард.
              </p>
              <p className="text-xs text-gray-500">— Денис & команда Капстрой</p>
            </div>
