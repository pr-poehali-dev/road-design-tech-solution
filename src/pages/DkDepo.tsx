...
const stages = [
  ...
  },
  {
    ...
    executor: [
      ...
      "Тепловизионная съёмка ограждающих конструкций (стены, покрытие, ворота) для определения зон теплопотерь и дефектов утепления",
    ...
    result: "Журнал обмеров, термограммы, акт обследования, фотофиксация",
  },
  {
    num: 3,
    ...
    executor: [
      ...
      "Определение фактических сопротивлений теплопередаче на основе тепловизионных данных и справочных материалов",
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex items-center gap-6 bg-indigo-700 text-white rounded p-4 mb-6 justify-center">
            ...
            <div className="w-px h-10 bg-white/30" />
            <div className="text-center">
              <div className="text-base font-bold">~1 мес.</div>
              <div className="text-xs">календарных</div>
            </div>
          </div>
