  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          {/* ── WATERMARK BANNER ── */}
          <div className="bg-red-50 border-2 border-red-500 rounded px-4 py-3 mb-6 text-center">
            <p className="text-xs font-bold text-red-700 leading-snug">
              ВНИМАНИЕ! Данный документ является сокращенным примером одной из методик расчета и не может быть использован для проектирования, экспертизы или строительства. Все расчёты и данные являются ориентировочными.
            </p>
            <p className="text-xs text-red-600 mt-2 leading-snug">
              В образце мы использовали типовые (референсные) значения сопротивления теплопередаче R, которые соответствуют стандартным решениям для промышленных зданий депо, построенных в 1970–2000 гг.
            </p>
          </div>
          ...
          <ul className="list-none text-xs text-gray-800 space-y-1 mb-3 ml-4">
            {[
              "выполнить натурное обследование объектов;",
